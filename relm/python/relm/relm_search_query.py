"""Define how a query runs declaratively.

Most users should use the SimpleSearchQuery API combined with relm.search.
Using the low-level API (i.e., SearchQuery) may cause breakage in the future.
...
class PrepareOptions:
    ...
    manage_device_placement: Optional[bool] = None
...
class SearchQuery:
    ...
    backend: SearchBackendType = SearchBackendType.AUTOMATA
